  ...
  return (
    <div className="px-6 py-4 flex flex-col gap-4">
      ...
      <div className="flex justify-start">
        <button className="bg-[#8B6914] text-white text-[11px] font-bold px-4 py-2 rounded-xl hover:bg-[#6a5010] transition-colors flex items-center gap-2">
          <img src="/images/ulule.png" className="w-4 h-4" alt="Ulule" /> {t.viewOnUlule}
        </button>
      </div>
    </div>
  );
